...
public class Cell extends Rectangle{
	/**
	 * Coordonnées construite à partir du x & y.
	 */
	ICoordinate coord;
	/**
	 * La valeur de décalage en X pour la position de la cellule.
	 */
	int gap_X;
	/**
	 * La valeur de décalage en Y pour la position de la cellule.
	 */
	int gap_Y;
	/**
	 * Le facteur de zoom pour la taille de la cellule.
	 */
	int zoom;
	
	/**
	 * Constructeur avec des paramètres limités. 
